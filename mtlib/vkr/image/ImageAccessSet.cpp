...
ImageAccessSet::ImageAccessSet()
{
  _accessTable.reserve(16);
}

bool ImageAccessSet::addImageAccess(const Image& image,
...
std::optional<ImageAccessSet> ImageAccessSet::merge(
                                                  const ImageAccessSet& first,
