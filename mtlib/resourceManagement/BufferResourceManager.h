...
namespace mt
{
  ...
  public:
    ...
    //  Попытаться загрузить данные немедленно.
    //  Никогда не возвращает nullptr
    //  Может вернуть пустой ресурс если не удается загрузить данные
    //    (нет файла, например).
    ...
    //    иначе запустит асинхронную задачу на загрузку данных и вернет
    //    пустой ресурс.
    //  После загрузки ресурсом владеет ownerQueue.
    //  Буфер будет создан как DataBuffer::STORAGE_BUFFER
    //  Потокобезопасный метод.
